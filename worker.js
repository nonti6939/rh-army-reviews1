// worker.js — RH ARMY reviews (public reviews API + private admin, all in one file)
//
// Needs: env.DB (D1), env.ASSETS (static files), env.ADMIN_PASSWORD (a Secret).
...
export default {
  async fetch(request, env) {
    // Private admin routes first (/admin and /api/admin/...)
...
// Returns a Response for admin routes, or null so the normal code handles the request.
